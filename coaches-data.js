...
window.ALL_COACHES=[
  ...
  /* ── 台灣 WBC 2026 教練團 ── */
  {id:'tw_mgr1',type:'mgr',name:'曾豪駒',en:'Tseng Hao-Chu',nat:'🇹🇼',lv:1,maxLv:5,ovr:82,bonus:'+5% 全隊調度',rarity:'l',av:'🧭',
   desc:'中華隊總教練，樂天桃猿一軍總教練，背號99。以穩健調度著稱，率隊出征 2026 WBC。',
   story:'曾豪駒長年深耕中華職棒，執掌樂天桃猿後建立系統化訓練體系。2026年受命帶領中華隊出征WBC，是台灣棒球新生代最具代表性的總教練。',
   skills:[{i:'🧭',n:'穩健調度',d:'全隊 OVR+5%'},{i:'🇹🇼',n:'本土教頭',d:'台灣球員加成+8%'},{i:'⚾',n:'WBC主帥',d:'短期賽表現提升'}],obtain:'任務'},
  {id:'tw_bat1',type:'bat',name:'彭政閔',en:'Peng Cheng-Min',nat:'🇹🇼',lv:2,maxLv:5,ovr:90,bonus:'+8% 打擊 OVR',rarity:'h',av:'🏏',
   desc:'「恰恰」，CPBL 傳奇打者，4000安打紀錄保持人，現任中信兄弟二軍總教練兼農場主管，背號23。',
   story:'彭政閔以20年職業生涯寫下CPBL最多安打紀錄。退役後投身教練工作，將畢生打擊功夫傾囊相授，是台灣打擊技術的最高象徵。',
   skills:[{i:'🏏',n:'4000安打',d:'打擊率+8%'},{i:'🌟',n:'恰恰精神',d:'關鍵打席成功率+12%'},{i:'🏆',n:'傳奇接班',d:'OBP+10%'}],obtain:'抽卡'},
  {id:'tw_bat2',type:'bat',name:'高國輝',en:'Ko Kuo-Hui',nat:'🇹🇼',lv:1,maxLv:5,ovr:78,bonus:'+5% 打擊 OVR',rarity:'r',av:'💥',
   desc:'富邦悍將一軍打擊教練，背號28。以強力打擊見長，執教風格強調積極揮棒與長打能力。',
   story:'高國輝在職業生涯中以長打能力著稱，退役後轉任教練，致力於培養有Power的打者。他執教的打者長打率明顯提升，是台灣強力打擊路線的重要推手。',
   skills:[{i:'💥',n:'強力打擊',d:'長打率+8%'},{i:'🔥',n:'積極揮棒',d:'HR+6%'},{i:'💪',n:'力量訓練',d:'打點+10%'}],obtain:'任務'},
  {id:'tw_pit1',type:'pit',name:'王建民',en:'Wang Chien-Ming',nat:'🇹🇼',lv:3,maxLv:5,ovr:93,bonus:'-10% 對手安打率',rarity:'h',av:'🌊',
   desc:'台灣之光、前洋基王牌，以下沉球稱霸MLB。現任中信兄弟牛棚教練，背號40。',
   story:'王建民是台灣棒球史上最成功的旅外球員，2006-07年連續14勝成為洋基主力先發。重傷復健後轉任教練，將下沉球技術與心理韌性傾囊相授。',
   skills:[{i:'🌊',n:'下沉球王',d:'滾地球率+20%'},{i:'🗽',n:'洋基王牌',d:'ERA-10%'},{i:'💎',n:'台灣之光',d:'投手體力消耗-15%'}],obtain:'抽卡'},
  {id:'tw_pit2',type:'pit',name:'林岳平',en:'Lin Yueh-Ping',nat:'🇹🇼',lv:1,maxLv:5,ovr:80,bonus:'-6% 對手安打率',rarity:'l',av:'⚡',
   desc:'統一獅一軍總教練，前職棒投手，背號70。以精準控球著稱，執教強調投球節奏管理。',
   story:'林岳平在職棒生涯以穩健控球著稱，執教後將精準帶入教學。擅長讓投手找到最適合自己的投球節奏，是台灣本土培育投手的重要推手。',
   skills:[{i:'⚡',n:'精準控球',d:'保送率-15%'},{i:'📐',n:'節奏管理',d:'投手穩定度+12%'},{i:'🇹🇼',n:'本土教練',d:'年輕投手成長加速'}],obtain:'任務'},
  {id:'tw_def1',type:'def',name:'陳江和',en:'Chen Chiang-Ho',nat:'🇹🇼',lv:1,maxLv:5,ovr:76,bonus:'+4% 守備能力',rarity:'r',av:'🛡️',
   desc:'中信兄弟一軍首席教練，擔任三壘指導教練，背號31。資深教練，執教經驗豐富。',
   story:'陳江和在台灣職棒執教多年，以細膩戰術佈局著稱。擔任三壘指導教練期間，精準的跑壘時機判斷讓球隊得分效率大幅提升。',
   skills:[{i:'🛡️',n:'三壘指導',d:'跑壘成功率+10%'},{i:'📋',n:'戰術佈局',d:'得分效率+8%'},{i:'🎯',n:'資深調度',d:'守備穩定+6%'}],obtain:'任務'},
  {id:'tw_def2',type:'def',name:'高志綱',en:'Kao Chih-Kang',nat:'🇹🇼',lv:1,maxLv:5,ovr:82,bonus:'+6% 守備能力',rarity:'l',av:'🥎',
   desc:'統一獅總監兼首席捕手教練，背號34。CPBL名捕，以配球智慧和守備領導力著稱。',
   story:'高志綱是台灣職棒最具代表性的捕手之一，配球藝術和守備領導力業界有口皆碑。退役轉任教練後培育多位優秀捕手，是台灣後場訓練的核心人物。',
   skills:[{i:'🥎',n:'配球藝術',d:'投手搭配效率+12%'},{i:'👁️',n:'後場領導',d:'守備協調+10%'},{i:'🏆',n:'名捕傳承',d:'捕手守備全面提升'}],obtain:'抽卡'},
  {id:'tw_def3',type:'def',name:'張建銘',en:'Chang Chien-Ming',nat:'🇹🇼',lv:1,maxLv:5,ovr:75,bonus:'+4% 守備能力',rarity:'r',av:'🧤',
   desc:'味全龍打擊兼外野守備教練，一壘指導，背號66。外野守備訓練專家。',
   story:'張建銘以外野守備見長，退役後專注於外野守備技術的系統化訓練。一壘指導工作精確，讓球隊跑壘積極性與成功率同步提升。',
   skills:[{i:'🧤',n:'外野守備',d:'外野接球率+10%'},{i:'🏃',n:'一壘指導',d:'盜壘成功率+8%'},{i:'🎯',n:'跑壘判斷',d:'跑壘失誤率-12%'}],obtain:'任務'},
  {id:'tw_fit1',type:'fit',name:'劉品辰',en:'Liu Pin-Chen',nat:'🇹🇼',lv:1,maxLv:5,ovr:74,bonus:'-14% 疲勞消耗',rarity:'r',av:'💪',
   desc:'樂天桃猿一軍體能教練，背號7。專精棒球體能訓練，強調功能性動作與傷害預防。',
   story:'劉品辰是台灣職棒年輕一代的體能教練代表，以科學化訓練方法和細膩的球員體能管理聞名。在他的照料下球員傷病率顯著降低，賽季後段表現更穩定。',
   skills:[{i:'💪',n:'體能訓練',d:'疲勞消耗-14%'},{i:'🏥',n:'傷害預防',d:'受傷機率-10%'},{i:'🇹🇼',n:'本土調養',d:'台灣球員恢復+12%'}],obtain:'任務'},
  {id:'tw_fit2',type:'fit',name:'高挺耀',en:'Kao Ting-Yao',nat:'🇹🇼',lv:1,maxLv:5,ovr:70,bonus:'-10% 疲勞消耗',rarity:'r',av:'🐛',
   desc:'富邦悍將訓練員兼牛棚捕手，背號75。負責投手熱身管理與牛棚調度支援。',
   story:'高挺耀是球隊幕後英雄，每場比賽默默在牛棚為投手暖身，掌握每位投手最佳狀態。他對投手體能的敏銳觀察讓教練組換投決策更加精準。',
   skills:[{i:'🐛',n:'牛棚管理',d:'牛棚投手疲勞-10%'},{i:'🌡️',n:'熱身掌控',d:'投手上場狀態+8%'},{i:'👁️',n:'狀態觀察',d:'投手傷病預警+10%'}],obtain:'任務'},
  {id:'tw_fit3',type:'fit',name:'吳瑀政',en:'Wu Yu-Cheng',nat:'🇹🇼',lv:1,maxLv:5,ovr:68,bonus:'-8% 疲勞消耗',rarity:'r',av:'🐣',
   desc:'統一獅練習生兼牛棚捕手，背號87。年輕的幕後支援，負責協助牛棚運作。',
   story:'吳瑀政是球隊中最年輕的幕後工作者，以滿滿的熱情支援牛棚工作。雖然資歷尚淺，但對棒球的熱忱讓整個牛棚氛圍更加積極。',
   skills:[{i:'🐣',n:'新生代熱情',d:'牛棚士氣提升+8%'},{i:'⚾',n:'牛棚支援',d:'投手疲勞-8%'},{i:'🌱',n:'成長中',d:'賽季後段加成'}],obtain:'任務'},
  {id:'tw_fit4',type:'fit',name:'邱世杰',en:'Chiu Shih-Chieh',nat:'🇹🇼',lv:1,maxLv:5,ovr:72,bonus:'-12% 疲勞消耗',rarity:'r',av:'🎯',
   desc:'味全龍體能教練兼餵球投手，背號97。負責打擊練習投球與球員體能管理。',
   story:'邱世杰身兼體能教練與餵球投手雙重角色，每天投出數百球協助打者練習，同時監控球員體能狀況。他的付出讓打者練習品質大幅提升。',
   skills:[{i:'🎯',n:'餵球專家',d:'打擊練習效率+15%'},{i:'💪',n:'雙重角色',d:'體力消耗-12%'},{i:'🏋️',n:'體能管理',d:'整體體力維持+10%'}],obtain:'任務'},
  /* ── 總教練 ── */
